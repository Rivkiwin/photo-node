...
class BaseService {
    ...
    create(rawObject, populate = '') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return saved.populate(populate).execPopulate();
            }
            catch (e) {
                console.log(e);
                throw e;
    ...
    // async listPagination(filters: object = {}, paginationParams?: PaginateOptions) {
    //     if (typeof this.model.paginate === 'function') {
    //         console.log("11+++++++++++++++++++++++++++++++++++2");
    //         return this.model.paginate(filters, paginationParams);
    //     }
    //                 console.log("11============================2");
